...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/Abba/stopwatch/stopwatch.runs/synth_1/.Xil/Vivado-35752-Ibukun/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog C:/Abba/stopwatch/stopwatch.srcs/sources_1/imports/stopwatch/stopwatch.v
      rt::filesetChecksum
    }
    rt::set_parameter usePostFindUniquification false
    set rt::top stopwatch_topmodule
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "C:/Abba/stopwatch/stopwatch.runs/synth_1/.Xil/Vivado-35752-Ibukun/"
