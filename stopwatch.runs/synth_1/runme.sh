...
HD_PWD='C:/Abba/stopwatch/stopwatch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_topmodule.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stopwatch_topmodule.tcl
