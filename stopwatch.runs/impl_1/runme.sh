...
HD_PWD='C:/Abba/stopwatch/stopwatch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stopwatch_topmodule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stopwatch_topmodule.tcl -notrace
